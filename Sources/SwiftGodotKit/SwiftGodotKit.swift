...
extension GodotInstance {
    ...
    public static func create(args: [String]) -> GodotInstance? {
        ...
        withUnsafePtr(strings: argsWithCmd, callback: { cstr in
            instance = libgodot.gdextension_create_godot_instance/*gCreateGodotInstance*/(Int32(argsWithCmd.count), cstr, { godotGetProcAddr, libraryPtr, extensionInit in
    ...
    public static func destroy(instance: GodotInstance) {
        gDestroyGodotInstance(UnsafeMutableRawPointer(mutating: instance.handle))
    }
