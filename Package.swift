...
//        .package(path: "../SwiftGodot")
    ...
    targets: [
        ...
        .binaryTarget(name: "libgodot", url: "https://github.com/Smirk-Software-Company/SwiftGodotKit/blob/main/libgodot.xcframework.zip", checksum: "76c2ae03151c30f9a7a7fa890ec8dbb1781becd1"),
//        .binaryTarget (
//            name: "libgodot",
